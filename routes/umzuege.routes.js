...
// const fileUpload = require('../middleware/fileUpload'); // Commented out - middleware not found
...
router.post('/:id/documents',
  umzugValidation.validateId,
  validate,
  // fileUpload.single('document'), // Commented out - middleware not found
